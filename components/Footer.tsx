        ...
        <div className="grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem]">
            <div className="flex items-center space-x-6">
                ...
                <div>
                    ...
                    <p className="text-[17px] w-[90%] text-white opacity-60">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde maiores cumque ab omnis possimus voluptate iusto velit? Praesentium, labore? A, maxime nostrum.</p>
                </div>
            </div>
            <div className="flex items-center space-x-6">
                <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]">
            ...
            <div className="flex items-center space-x-6">
                ...
                <div>
                    ...
                    <p className="text-[17px] w-[90%] text-white opacity-60">Example.com <br/> example@example.com</p>
                </div>
            </div>
        </div>
